...
declare module PROJECT {
    interface ITrackNode {
        ...
        rotation: BABYLON.IUnityQuaternion;
    }
...
declare module PROJECT {
    ...
    class StandardCarController extends BABYLON.ScriptComponent {
        static MIN_RPM: number;
        static MAX_RPM: number;
        private _rigidbody;
        ...
        drive(throttle: number, steering: number, braking: boolean, drifting: boolean, assisted?: boolean): void;
